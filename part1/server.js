...
// ### Challenge 4:
// Create a GET route for "/verify/:age" that checks if the age is greater than 13. If it is
// then it sends a 200 status response (for all good). If it is not greater than 13 then send a
// 403 status code. For more information on what status codes mean refer to this -
